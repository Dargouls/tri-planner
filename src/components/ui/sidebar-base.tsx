...
export const SidebarProvider = ({
	...
	return (
		<SidebarContext.Provider value={{ open, setOpen, animate: animate }}>{children}</SidebarContext.Provider>
	);
};
...
export const SidebarLink = ({
	...
	return (
		...
		>
			...
			>
				{link?.label}
				<Skeleton className={cn('h-4 w-16', link?.label ? 'hidden' : 'inline-block')} />
			</motion.span>
		</Link>
	);
};
